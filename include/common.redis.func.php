...
function getPlayUrlList($ifrom,$url,$typeid,$vId,$starget,$sdate,$enname,$listyle='li'){
	...
	for($i=0;$i<=$urlCount;$i++){
		if(!empty($urlArray[$i])){
			...
			if($paras[0]==$ifrom && $i==$paras[1]) $style.=" active\""; else $style.="\"";			
			if($paras[0]==$ifrom && $i==$paras[1]) $playon.="<div class=\"playon\"><i></i><i></i><i></i><i></i></div>"; else $playon.="";			
			...
			if ($cfg_isalertwin){
				...
				$urlStr.="<a href=\"".getPlayLink2($typeid,$vId,$sdate,$enname,$ifrom,$i)."\" class=\"active\" title=\"播放".$singleUrlArray[0]."\">".$singleUrlArray[0]."".$playon."</a>";
			}
		}
	}
	//$urlStr.="</ul>";
	...
	for($i=0;$i<=$urlCount;$i++){
		if(!empty($urlArray[$i])){
			...
			if ($cfg_isalertwin){
				...
				$urlStr=getPlayLink2($typeid,$vId,$sdate,$enname,$ifrom,0);
			}
		}
	}
	//$urlStr.="</ul>";
