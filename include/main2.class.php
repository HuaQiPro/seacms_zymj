...
class MainClass_Template {
	...
	function parseGlobal($content) {
		...
		$content = str_replace ( "{zuoz:znologot}", $GLOBALS ['cfg_znologot'], $content );
		$content = str_replace ( "{zuoz:znologo}", $GLOBALS ['cfg_znologo'], $content );
		$content = str_replace ( "{zuoz:znobanner_h1}", $GLOBALS ['cfg_znobanner_h1'], $content );
		$content = str_replace ( "{zuoz:znobanner_p}", $GLOBALS ['cfg_znobanner_p'], $content );
