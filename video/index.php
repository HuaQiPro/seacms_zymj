...
function echoPlay($vId)
{
	...
	$partNameNX=getPartName2($row['v_playdata'],$id,$from-1);
	...
	$content = str_replace("{playpage:dzx}",$partNameN[2],$content);
	$content = str_replace("{playpage:dzs}",$partNameNX[2],$content);
