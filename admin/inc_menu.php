...
$menu=array (
	...
	'system'=>array (
		...
		5=>"",
		6=>"<a target='I2' href='admin_player.php?action=boardsource'>播放来源管理</a>",
		7=>"<a target='I2' href='admin_playerdown.php?action=boardsource'>下载来源管理</a>",
		8=>"",
		9=>"<a target='I2' href='admin_manager.php'>系统账号管理</a>",
		10=>"<a target='I2' href='admin_vcode.php'>后台登陆验证码</a>",
		11=>"<a target='I2' href='admin_isapi.php'>资源库API设置</a>",
		12=>"<a target='I2' href='admin_ip.php'>后台IP安全设置</a>",
		13=>"<a target='I2' href='admin_weixin.php'>微信公众号设置</a>",
		14=>"<a target='I2' href='admin_smtp.php'>邮件服务器设置</a>",
	),
);
$menuedit=array(
	'editor'=>array(
